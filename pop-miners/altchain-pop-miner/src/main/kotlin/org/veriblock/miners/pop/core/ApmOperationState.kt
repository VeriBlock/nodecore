...
object ApmOperationState {
    ...
    val SUBMITTED_POP_DATA = MiningOperationState(6, "VBK Publications submitted", "Confirm ATV", PROVEN)
    val PAYOUT_DETECTED = MiningOperationState(7, "Payout detected", "Complete and save", PROVEN)
