...
export class ApiService {
  ...
  getConfiguredAltchains(): Observable<ConfiguredAltchainList> {
    return this.http.get<ConfiguredAltchainList>(
      `${environment.apiUrl}/miner/configured-altchains`
    );
  }
}
