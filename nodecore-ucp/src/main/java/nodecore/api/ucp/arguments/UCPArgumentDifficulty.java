...
public class UCPArgumentDifficulty extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.DIFFICULTY;
     ...
     * @param data
     */
    public UCPArgumentDifficulty(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentDifficulty(Integer data) {
