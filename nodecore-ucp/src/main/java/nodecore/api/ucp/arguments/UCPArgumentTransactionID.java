...
public class UCPArgumentTransactionID extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TRANSACTION_ID;
     ...
     * @param data
     */
    public UCPArgumentTransactionID(String data) {
        if (data == null) {
