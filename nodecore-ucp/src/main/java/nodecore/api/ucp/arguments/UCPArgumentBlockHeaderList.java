...
public class UCPArgumentBlockHeaderList extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.BLOCK_HEADER_LIST;
     ...
     * @param data
     */
    public UCPArgumentBlockHeaderList(String data) {
        if (data == null) {
        ...
        // Test to ensure we can reconstitute this serlialized-format data later
        new BlockHeaderList(data);
     ...
     */
    public BlockHeaderList getData() {
        return new BlockHeaderList(data);
    }
