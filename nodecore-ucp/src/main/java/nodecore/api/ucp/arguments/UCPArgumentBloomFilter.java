...
public class UCPArgumentBloomFilter extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.BLOOM_FILTER;
     ...
     * @param data
     */
    public UCPArgumentBloomFilter(String data) {
        if (data == null) {
