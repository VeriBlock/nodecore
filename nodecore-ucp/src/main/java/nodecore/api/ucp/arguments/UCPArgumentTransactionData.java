...
public class UCPArgumentTransactionData extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TRANSACTION_DATA;
     ...
     * @param data
     */
    public UCPArgumentTransactionData(String data) {
        if (data == null) {
