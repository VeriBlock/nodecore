...
public class UCPArgumentNonce extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.NONCE;
     ...
     * @param data
     */
    public UCPArgumentNonce(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentNonce(Integer data) {
