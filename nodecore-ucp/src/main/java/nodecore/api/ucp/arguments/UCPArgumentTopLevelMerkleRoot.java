...
public class UCPArgumentTopLevelMerkleRoot extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TOP_LEVEL_MERKLE_ROOT;
     ...
     * @param data
     */
    public UCPArgumentTopLevelMerkleRoot(String data) {
        if (data == null) {
