...
public class UCPArgumentMinerComment extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.MINER_COMMENT;
     ...
     * @param data
     */
    public UCPArgumentMinerComment(String data) {
        if (data == null) {
