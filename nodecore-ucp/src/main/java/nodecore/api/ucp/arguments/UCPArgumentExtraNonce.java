...
public class UCPArgumentExtraNonce extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.EXTRA_NONCE;
     ...
     * @param data
     */
    public UCPArgumentExtraNonce(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentExtraNonce(Long data) {
