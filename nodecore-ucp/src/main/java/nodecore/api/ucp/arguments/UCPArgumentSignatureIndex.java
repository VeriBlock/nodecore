...
public class UCPArgumentSignatureIndex extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.SIGNATURE_INDEX;
     ...
     * @param data
     */
    public UCPArgumentSignatureIndex(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentSignatureIndex(Long data) {
