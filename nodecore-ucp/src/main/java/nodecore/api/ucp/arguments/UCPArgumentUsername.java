...
public class UCPArgumentUsername extends UCPArgument {

    private final UCPArgumentUsername.UCPType type = UCPType.USERNAME;
     ...
     * @param data
     */
    public UCPArgumentUsername(String data) {
        if (data == null) {
