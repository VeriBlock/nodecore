...
// TODO: Add some sort of TransactionContextPackage object or similar, let this return an array of them.
public class UCPArgumentTransactionsWithContext extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TRANSACTIONS_WITH_CONTEXT;
     ...
     * @param data
     */
    public UCPArgumentTransactionsWithContext(String data) {
        if (data == null) {
