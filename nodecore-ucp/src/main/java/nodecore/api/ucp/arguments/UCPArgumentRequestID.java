...
public class UCPArgumentRequestID extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.REQUEST_ID;
     ...
     * @param data
     */
    public UCPArgumentRequestID(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentRequestID(Integer data) {
