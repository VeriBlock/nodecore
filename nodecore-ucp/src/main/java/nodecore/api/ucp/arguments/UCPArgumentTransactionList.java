...
import nodecore.api.ucp.storage.TransactionDataList;

public class UCPArgumentTransactionList extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TRANSACTION_LIST;
     ...
     * @param data
     */
    public UCPArgumentTransactionList(String data) {
        if (data == null) {
        ...
        // Test to make sure data is valid for constructing a TransactionDataList
        new TransactionDataList(data);
    }

    public UCPArgumentTransactionList(TransactionDataList transaction_list) {
        this(transaction_list.serialize());
    }
     ...
     */
    public TransactionDataList getData() {
        return new TransactionDataList(data);
    }
