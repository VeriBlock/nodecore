...
public class UCPArgumentFrequencyMS extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.FREQUENCY_MS;
     ...
     * @param data
     */
    public UCPArgumentFrequencyMS(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentFrequencyMS(Integer data) {
