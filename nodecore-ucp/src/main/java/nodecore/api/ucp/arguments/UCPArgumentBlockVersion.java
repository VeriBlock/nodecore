...
public class UCPArgumentBlockVersion extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.BLOCK_VERSION;
     ...
     * @param data
     */
    public UCPArgumentBlockVersion(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentBlockVersion(Integer data) {
