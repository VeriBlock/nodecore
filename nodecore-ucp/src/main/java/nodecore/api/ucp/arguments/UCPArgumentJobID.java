...
public class UCPArgumentJobID extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.JOB_ID;
     ...
     * @param data
     */
    public UCPArgumentJobID(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentJobID(Integer data) {
