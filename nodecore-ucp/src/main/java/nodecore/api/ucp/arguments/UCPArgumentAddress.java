...
public class UCPArgumentAddress extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.ADDRESS;
     ...
     * @param data
     */
    public UCPArgumentAddress(String data) {
        if (data == null) {
        ...
        if (!AddressUtility.isValidStandardOrMultisigAddress(data)) {
            throw new IllegalArgumentException(getClass().getCanonicalName() + "'s constructor cannot be called with an invalid address (" + data + ")!");
        }
