...
public class UCPArgumentBalance extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.BALANCE;
     ...
     * @param data
     */
    public UCPArgumentBalance(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentBalance(Long data) {
        ...
        if (!UCPArgument.UCPType.BALANCE.preliminaryValidation(serialized)) {
