...
public class UCPArgumentLedgerHash extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.LEDGER_HASH;
     ...
     * @param data
     */
    public UCPArgumentLedgerHash(String data) {
        if (data == null) {
