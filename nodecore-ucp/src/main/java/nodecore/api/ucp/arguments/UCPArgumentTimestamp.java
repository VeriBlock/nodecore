...
public class UCPArgumentTimestamp extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.TIMESTAMP;
     ...
     * @param data
     */
    public UCPArgumentTimestamp(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public UCPArgumentTimestamp(Integer data) {
