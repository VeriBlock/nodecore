...
public class UCPArgumentIntermediateLevelMerkleRoot extends UCPArgument {

    private final UCPArgument.UCPType type = UCPType.INTERMEDIATE_LEVEL_MERKLE_ROOT;
     ...
     * @param data
     */
    public UCPArgumentIntermediateLevelMerkleRoot(String data) {
        if (data == null) {
