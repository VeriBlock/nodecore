...
class BitcoinMerklePathTest {
    ...
    fun `should create a valid BitcoinMerklePath with the given path string`() {
       ...
       val merklePath = BitcoinMerklePath(compactFormat)
        ...
        merklePath.bottomData shouldBe DatatypeConverter.parseHexBinary("EDB77EEB95390EAA4DAE3BFEC958AEE2BB729CEB3305E16EB4503A2CE41C09B4")
        merklePath.layers.size shouldBe 6
        merklePath.layers[0] shouldBe DatatypeConverter.parseHexBinary("A05201273D4BC9E3326F8DA6ADFD700C8DD23CF8F796C49187E38034ACFAFD7E")
        merklePath.layers[1] shouldBe DatatypeConverter.parseHexBinary("B6493A8B2F89487C67278D09CF1BF9770733B6E9E948443882CA9DB95DACB8FD")
        merklePath.layers[2] shouldBe DatatypeConverter.parseHexBinary("67CCFE77CD7163C0E74198652BAE98E98B94FA0852AD6DD4449F581D22D54147")
        merklePath.layers[3] shouldBe DatatypeConverter.parseHexBinary("1E38565FE97FC3973B7CE721F8011B59BC0C3331A8CC68A63BDC10CE20CD79AA")
        merklePath.layers[4] shouldBe DatatypeConverter.parseHexBinary("F724DC14859055A7E663F22D40815605083D9489C2E00C8ECAF529B8D92CE854")
        merklePath.layers[5] shouldBe DatatypeConverter.parseHexBinary("8A0C5825023D35CEA815F066BF030F740D03D98877E9A9DA6E88DAB69C07CC2D")
    }
    ...
    fun `should create a valid BitcoinMerklePath with the given parameters`() {
        ...
        val layers = ArrayList<ByteArray>()
        layers.add(DatatypeConverter.parseHexBinary("A05201273D4BC9E3326F8DA6ADFD700C8DD23CF8F796C49187E38034ACFAFD7E"))
        layers.add(DatatypeConverter.parseHexBinary("B6493A8B2F89487C67278D09CF1BF9770733B6E9E948443882CA9DB95DACB8FD"))
        layers.add(DatatypeConverter.parseHexBinary("67CCFE77CD7163C0E74198652BAE98E98B94FA0852AD6DD4449F581D22D54147"))
        layers.add(DatatypeConverter.parseHexBinary("1E38565FE97FC3973B7CE721F8011B59BC0C3331A8CC68A63BDC10CE20CD79AA"))
        layers.add(DatatypeConverter.parseHexBinary("F724DC14859055A7E663F22D40815605083D9489C2E00C8ECAF529B8D92CE854"))
        layers.add(DatatypeConverter.parseHexBinary("8A0C5825023D35CEA815F066BF030F740D03D98877E9A9DA6E88DAB69C07CC2D"))
        val bottomData = DatatypeConverter.parseHexBinary("EDB77EEB95390EAA4DAE3BFEC958AEE2BB729CEB3305E16EB4503A2CE41C09B4")
