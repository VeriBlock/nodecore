...
public class StratumArgumentAgent extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.AGENT;
     ...
     * @param data
     */
    public StratumArgumentAgent(String data) {
        if (data == null) {
