...
public class StratumArgumentHeaderHash extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.HEADER_HASH;
     ...
     * @param data
     */
    public StratumArgumentHeaderHash(String data) {
        if (data == null) {
