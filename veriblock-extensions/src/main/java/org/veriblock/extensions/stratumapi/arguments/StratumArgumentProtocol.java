...
public class StratumArgumentProtocol extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.PROTOCOL;
     ...
     * @param data
     */
    public StratumArgumentProtocol(String data) {
        if (data == null) {
