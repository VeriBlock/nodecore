...
public class StratumArgumentJobId extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.JOB_ID;
     ...
     * @param data
     */
    public StratumArgumentJobId(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public StratumArgumentJobId(Integer data) {
