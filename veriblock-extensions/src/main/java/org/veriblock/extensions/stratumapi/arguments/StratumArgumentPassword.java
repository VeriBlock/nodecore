...
public class StratumArgumentPassword extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.PASSWORD;
     ...
     * @param data
     */
    public StratumArgumentPassword(String data) {
        if (data == null) {
