...
public class StratumArgumentBoolean extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.BOOLEAN;
     ...
     * @param data
     */
    public StratumArgumentBoolean(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public StratumArgumentBoolean(Boolean data) {
