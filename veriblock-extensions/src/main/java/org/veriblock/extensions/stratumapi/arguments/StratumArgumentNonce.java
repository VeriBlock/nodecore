...
public class StratumArgumentNonce extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.NONCE;
     ...
     * @param data
     */
    public StratumArgumentNonce(String data) {
        if (data == null) {
