...
public class StratumArgumentSeedHash extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.SEED_HASH;
     ...
     * @param data
     */
    public StratumArgumentSeedHash(String data) {
        if (data == null) {
