...
public class StratumArgumentHost extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.HOST;
     ...
     * @param data
     */
    public StratumArgumentHost(String data) {
        if (data == null) {
