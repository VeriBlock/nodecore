...
public class StratumArgumentBlockHeight extends StratumArgument {

    private final StratumArgument.StratumType type = StratumType.BLOCK_HEIGHT;
     ...
     * @param data
     */
    public StratumArgumentBlockHeight(String data) {
        if (data == null) {
     ...
     * @param data
     */
    public StratumArgumentBlockHeight(Integer data) {
