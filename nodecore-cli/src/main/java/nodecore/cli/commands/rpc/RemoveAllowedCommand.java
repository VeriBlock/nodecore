...
public class RemoveAllowedCommand implements Command {
    private static final Logger _logger = LoggerFactory.getLogger(RemoveAllowedCommand.class);

    @Inject
    public RemoveAllowedCommand() {
    }
