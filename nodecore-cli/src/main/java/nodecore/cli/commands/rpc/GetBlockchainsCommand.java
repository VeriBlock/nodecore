...
import nodecore.api.grpc.GetBlockchainsReply;
import nodecore.api.grpc.GetBlockchainsRequest;
...
public class GetBlockchainsCommand implements Command {
    ...
    public Result execute(CommandContext context) {
        ...
        try {
            GetBlockchainsReply reply = context
                    .adminService()
                    .getBlockchains(GetBlockchainsRequest
                            .newBuilder()
                            .build());
            if (!reply.getSuccess()) {
                result.fail();
