...
public class ClearBannedMinersCommand implements Command {
    private static final Logger _logger = LoggerFactory.getLogger(ClearBannedMinersCommand.class);

    @Inject
    public ClearBannedMinersCommand() {
    }
